...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="https://github.com/dfpo520-claw-bot/AgentDock/issues/new"><strong>Сообщить об Issue</strong></a>
</p>
...
- **DeepAi助手 AI API** — Внутренняя тестовая платформа, совместимая с OpenAI
...
Перейдите на [Releases](https://github.com/dfpo520-claw-bot/AgentDock/releases/latest) для последней версии:
...
| [ClawApp](https://github.com/DeepAi助手/clawapp) | Кроссплатформенный мобильный чат |
| [cftunnel](https://github.com/DeepAi助手/cftunnel) | Инструмент Cloudflare Tunnel |
