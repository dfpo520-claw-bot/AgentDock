...
import { createGatewayBannerController } from './app-shell/gateway-banner.js'
  ...
  overlay.innerHTML = `
    <div class="login-card" style="text-align:center">
      ...
      <div style="margin-top:16px;font-size:11px;color:#aaa">
        <a href="${PRODUCT_IDENTITY.homepage}" target="_blank" rel="noopener" style="color:#aaa;text-decoration:none">${PRODUCT_IDENTITY.homepageHost}</a>
...
async function boot() {
  ...
  topbar.innerHTML = `
    ...
    <span class="mobile-topbar-title">${PRODUCT_IDENTITY.name}</span>
  `
  ...
  try {
    ...
    banner.innerHTML = `
      <div class="update-banner-content">
        ...
        <a class="btn btn-sm" href="${PRODUCT_IDENTITY.homepage}" target="_blank" rel="noopener">${t('about.downloadFromWebsite')}</a>
        <a class="btn btn-sm" href="${PRODUCT_IDENTITY.releaseUrl}" target="_blank" rel="noopener">Releases</a>
  ...
  try {
    ...
    if (app) app.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:20px;text-align:center;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
        ...
        <div style="margin-top:24px;font-size:11px;color:#a1a1aa">${t('common.pageLoadFailedHint')}<br><a href="${PRODUCT_IDENTITY.supportUrl}" target="_blank" style="color:#6366f1">${PRODUCT_IDENTITY.supportUrl}</a></div>
      </div>`
  }
  startUpdateChecker()
