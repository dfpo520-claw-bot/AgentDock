  ...
  if (!s.installed) {
    el.innerHTML = `
      ...
      <div style="display:flex;gap:var(--space-sm);align-items:center">
        ...
        <a class="btn btn-secondary btn-sm" href="https://github.com/DeepAi助手/cftunnel" target="_blank" rel="noopener">${t('ext.viewDocs')}</a>
      </div>
  ...
  if (!s.installed) {
    el.innerHTML = `
      ...
      <div style="display:flex;gap:var(--space-sm);align-items:center">
        ...
        <a class="btn btn-secondary btn-sm" href="https://github.com/DeepAi助手/clawapp" target="_blank" rel="noopener">${t('ext.viewDocs')}</a>
      </div>
