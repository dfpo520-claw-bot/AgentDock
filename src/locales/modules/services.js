...
export default {
  ...
  uninstallImpactStop: _('Gateway 将立即停止，所有连接到 AgentDock 的渠道会下线', 'Gateway will stop immediately and all channels connected to AgentDock will go offline', 'Gateway 將立即停止，所有連接到 AgentDock 的頻道會下線', 'Gateway は直ちに停止し、AgentDock に接続中のチャンネルがオフラインになります', 'Gateway가 즉시 중지되고 AgentDock에 연결된 모든 채널이 오프라인 상태가 됩니다', 'Gateway sẽ dừng ngay lập tức và tất cả kênh kết nối tới AgentDock sẽ ngoại tuyến', 'El Gateway se detendrá de inmediato y todos los canales conectados a AgentDock quedarán desconectados', 'O Gateway será interrompido imediatamente e todos os canais conectados ao AgentDock ficarão offline', 'Gateway будет немедленно остановлен, и все каналы, подключённые к AgentDock, перейдут в офлайн', 'Le Gateway s\u2019arrêtera immédiatement et tous les canaux liés à AgentDock passeront hors ligne', 'Gateway wird sofort gestoppt und alle mit AgentDock verbundenen Kanäle gehen offline'),
